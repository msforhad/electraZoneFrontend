    ...
    return (
      <div className="mx-6">
        <div className="flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10">
          <div className="relative flex-1 flex flex-col bg-[#f5a07e48] rounded-3xl xl:min-h-100 group">
            <div className="p-5 sm:p-16">
              ...
              <h2 className="text-3xl sm:text-5xl leading-[1.2] my-3 font-medium bg-gradient-to-r from-slate-600 to-[#f59f7e] bg-clip-text text-transparent max-w-xs  sm:max-w-md">
              ...
              <button className="bg-slate-800 text-white text-sm py-2.5 px-8 sm:py-3 sm:px-8 mt-4 sm:mt-10 rounded-md hover:bg-slate-900 hover:scale-103 active:scale-95 transition">
                LEARN MORE
              </button>
            </div>
            <Image
